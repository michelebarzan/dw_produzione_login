var applicazioni;
var serverName;
var dw_produzione_params;

window.addEventListener("load", async function(event)
{
    checkCoockies();
    applicazioni=await getApplicazioni();

    dw_produzione_params=await getDwProduzioneParams();
});
...
function getElencoApplicazioni()
{
    ...
    applicazioni.forEach(function(applicazione)
    {
        ...
        a.setAttribute("href",dw_produzione_params.web_server_info.protocol+"://"+dw_produzione_params.web_server_info.name+":"+dw_produzione_params.web_server_info.port+"/"+applicazione.percorsoIndex);
